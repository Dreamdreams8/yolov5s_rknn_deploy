...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r'../runs/train/exp/weights/best.pt', help='weights path')  # from yolov5/models/
